...
import { WarningOutlineIcon } from '../../components'
import { KUI_COLOR_TEXT_PRIMARY } from '@kong/design-tokens'

describe('WarningOutlineIcon', () => {
  it('matches snapshot', () => {
    const wrapper = mount(WarningOutlineIcon, {
      props: {
    ...
    expect(wrapper.html()).toMatchFileSnapshot(`./__snapshots__/WarningOutlineIcon.html`)
  })
