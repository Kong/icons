...
import { CheckSmallIcon } from '../../components'
import { KUI_COLOR_TEXT_PRIMARY } from '@kong/design-tokens'

describe('CheckSmallIcon', () => {
  it('matches snapshot', () => {
    const wrapper = mount(CheckSmallIcon, {
      props: {
    ...
    expect(wrapper.html()).toMatchFileSnapshot(`./__snapshots__/CheckSmallIcon.html`)
  })
