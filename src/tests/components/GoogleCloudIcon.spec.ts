...
describe('GoogleCloudIcon', () => {
  it('matches snapshot', () => {
    ...
    expect(wrapper.html()).toMatchFileSnapshot(`./__snapshots__/GoogleCloudIcon.html`)
  })
