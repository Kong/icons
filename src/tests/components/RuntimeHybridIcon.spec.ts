...
import { RuntimeHybridIcon } from '../../components'
import { KUI_COLOR_TEXT_PRIMARY } from '@kong/design-tokens'

describe('RuntimeHybridIcon', () => {
  it('matches snapshot', () => {
    const wrapper = mount(RuntimeHybridIcon, {
      props: {
    ...
    expect(wrapper.html()).toMatchFileSnapshot(`./__snapshots__/RuntimeHybridIcon.html`)
  })
