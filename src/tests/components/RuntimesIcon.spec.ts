...
import { RuntimesIcon } from '../../components'
import { KUI_COLOR_TEXT_PRIMARY } from '@kong/design-tokens'

describe('RuntimesIcon', () => {
  it('matches snapshot', () => {
    const wrapper = mount(RuntimesIcon, {
      props: {
    ...
    expect(wrapper.html()).toMatchFileSnapshot(`./__snapshots__/RuntimesIcon.html`)
  })
