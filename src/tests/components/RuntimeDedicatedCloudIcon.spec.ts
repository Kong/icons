/**
 * RuntimeDedicatedCloudIcon.spec.ts
...
import { RuntimeDedicatedCloudIcon } from '../../components'
import { KUI_COLOR_TEXT_PRIMARY } from '@kong/design-tokens'

describe('RuntimeDedicatedCloudIcon', () => {
  it('matches snapshot', () => {
    const wrapper = mount(RuntimeDedicatedCloudIcon, {
      props: {
    ...
    expect(wrapper.html()).toMatchFileSnapshot(`./__snapshots__/RuntimeDedicatedCloudIcon.html`)
  })
  ...
  describe('Component Props', () => {
    ...
    describe('size', () => {
      ...
      it('converts a string with `px` suffix to a valid icon size', () => {
        ...
        mount(RuntimeDedicatedCloudIcon, {
          props: {
            size,
          },
        })
