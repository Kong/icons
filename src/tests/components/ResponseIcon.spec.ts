...
describe('ResponseIcon', () => {
  it('matches snapshot', () => {
    ...
    expect(wrapper.html()).toMatchFileSnapshot(`./__snapshots__/ResponseIcon.html`)
  })
