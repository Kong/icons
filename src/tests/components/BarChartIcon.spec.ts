...
describe('BarChartIcon', () => {
  it('matches snapshot', () => {
    ...
    expect(wrapper.html()).toMatchFileSnapshot(`./__snapshots__/BarChartIcon.html`)
  })
