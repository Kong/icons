...
import { FeatureRequestIcon } from '../../components'
import { KUI_COLOR_TEXT_PRIMARY } from '@kong/design-tokens'

describe('FeatureRequestIcon', () => {
  it('matches snapshot', () => {
    const wrapper = mount(FeatureRequestIcon, {
      props: {
    ...
    expect(wrapper.html()).toMatchFileSnapshot(`./__snapshots__/FeatureRequestIcon.html`)
  })
