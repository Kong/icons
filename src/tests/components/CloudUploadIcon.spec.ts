...
describe('CloudUploadIcon', () => {
  it('matches snapshot', () => {
    const wrapper = mount(CloudUploadIcon, {
      props: {
    ...
    expect(wrapper.html()).toMatchFileSnapshot(`./__snapshots__/CloudUploadIcon.html`)
  })
