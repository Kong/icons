...
describe('CheckCircleIcon', () => {
  it('matches snapshot', () => {
    const wrapper = mount(CheckCircleIcon, {
      props: {
    ...
    expect(wrapper.html()).toMatchFileSnapshot(`./__snapshots__/CheckCircleIcon.html`)
  })
