...
describe('OverviewIcon', () => {
  it('matches snapshot', () => {
    ...
    expect(wrapper.html()).toMatchFileSnapshot(`./__snapshots__/OverviewIcon.html`)
  })
