...
import { RuntimeCompositeIcon } from '../../components'
import { KUI_COLOR_TEXT_PRIMARY } from '@kong/design-tokens'

describe('RuntimeCompositeIcon', () => {
  it('matches snapshot', () => {
    const wrapper = mount(RuntimeCompositeIcon, {
      props: {
    ...
    expect(wrapper.html()).toMatchFileSnapshot(`./__snapshots__/RuntimeCompositeIcon.html`)
  })
