...
import { TeammateIcon } from '../../components'
import { KUI_COLOR_TEXT_PRIMARY } from '@kong/design-tokens'

describe('TeammateIcon', () => {
  it('matches snapshot', () => {
    const wrapper = mount(TeammateIcon, {
      props: {
    ...
    expect(wrapper.html()).toMatchFileSnapshot(`./__snapshots__/TeammateIcon.html`)
  })
