...
import { GraduationIcon } from '../../components'
import { KUI_COLOR_TEXT_PRIMARY } from '@kong/design-tokens'

describe('GraduationIcon', () => {
  it('matches snapshot', () => {
    const wrapper = mount(GraduationIcon, {
      props: {
    ...
    expect(wrapper.html()).toMatchFileSnapshot(`./__snapshots__/GraduationIcon.html`)
  })
