/**
 * IndeterminateSmallIcon.spec.ts
...
import { IndeterminateSmallIcon } from '../../components'
import { KUI_COLOR_TEXT_PRIMARY } from '@kong/design-tokens'

describe('IndeterminateSmallIcon', () => {
  it('matches snapshot', () => {
    const wrapper = mount(IndeterminateSmallIcon, {
      props: {
    ...
    expect(wrapper.html()).toMatchFileSnapshot(`./__snapshots__/IndeterminateSmallIcon.html`)
  })
