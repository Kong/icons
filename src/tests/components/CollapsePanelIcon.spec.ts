...
import { CollapsePanelIcon } from '../../components'
import { KUI_COLOR_TEXT_PRIMARY } from '@kong/design-tokens'

describe('CollapsePanelIcon', () => {
  it('matches snapshot', () => {
    const wrapper = mount(CollapsePanelIcon, {
      props: {
    ...
    expect(wrapper.html()).toMatchFileSnapshot(`./__snapshots__/CollapsePanelIcon.html`)
  })
