...
import { AddChartIcon } from '../../components'
import { KUI_COLOR_TEXT_PRIMARY } from '@kong/design-tokens'

describe('AddChartIcon', () => {
  it('matches snapshot', () => {
    const wrapper = mount(AddChartIcon, {
      props: {
    ...
    expect(wrapper.html()).toMatchFileSnapshot(`./__snapshots__/AddChartIcon.html`)
  })
