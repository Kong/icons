...
import { RuntimeKicIcon } from '../../components'
import { KUI_COLOR_TEXT_PRIMARY } from '@kong/design-tokens'

describe('RuntimeKicIcon', () => {
  it('matches snapshot', () => {
    const wrapper = mount(RuntimeKicIcon, {
      props: {
    ...
    expect(wrapper.html()).toMatchFileSnapshot(`./__snapshots__/RuntimeKicIcon.html`)
  })
