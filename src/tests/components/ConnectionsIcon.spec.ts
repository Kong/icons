...
import { ConnectionsIcon } from '../../components'
import { KUI_COLOR_TEXT_PRIMARY } from '@kong/design-tokens'

describe('ConnectionsIcon', () => {
  it('matches snapshot', () => {
    const wrapper = mount(ConnectionsIcon, {
      props: {
    ...
    expect(wrapper.html()).toMatchFileSnapshot(`./__snapshots__/ConnectionsIcon.html`)
  })
