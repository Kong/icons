...
import { DataReportIcon } from '../../components'
import { KUI_COLOR_TEXT_PRIMARY } from '@kong/design-tokens'

describe('DataReportIcon', () => {
  it('matches snapshot', () => {
    const wrapper = mount(DataReportIcon, {
      props: {
    ...
    expect(wrapper.html()).toMatchFileSnapshot(`./__snapshots__/DataReportIcon.html`)
  })
