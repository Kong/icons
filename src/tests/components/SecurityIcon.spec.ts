...
import { SecurityIcon } from '../../components'
import { KUI_COLOR_TEXT_PRIMARY } from '@kong/design-tokens'

describe('SecurityIcon', () => {
  it('matches snapshot', () => {
    const wrapper = mount(SecurityIcon, {
      props: {
    ...
    expect(wrapper.html()).toMatchFileSnapshot(`./__snapshots__/SecurityIcon.html`)
  })
