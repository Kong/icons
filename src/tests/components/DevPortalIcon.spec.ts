...
import { DevPortalIcon } from '../../components'
import { KUI_COLOR_TEXT_PRIMARY } from '@kong/design-tokens'

describe('DevPortalIcon', () => {
  it('matches snapshot', () => {
    const wrapper = mount(DevPortalIcon, {
      props: {
    ...
    expect(wrapper.html()).toMatchFileSnapshot(`./__snapshots__/DevPortalIcon.html`)
  })
