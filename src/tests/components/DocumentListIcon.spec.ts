...
import { DocumentListIcon } from '../../components'
import { KUI_COLOR_TEXT_PRIMARY } from '@kong/design-tokens'

describe('DocumentListIcon', () => {
  it('matches snapshot', () => {
    const wrapper = mount(DocumentListIcon, {
      props: {
    ...
    expect(wrapper.html()).toMatchFileSnapshot(`./__snapshots__/DocumentListIcon.html`)
  })
