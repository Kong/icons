...
import { DangerCircleIcon } from '../../components'
import { KUI_COLOR_TEXT_PRIMARY } from '@kong/design-tokens'

describe('DangerCircleIcon', () => {
  it('matches snapshot', () => {
    const wrapper = mount(DangerCircleIcon, {
      props: {
    ...
    expect(wrapper.html()).toMatchFileSnapshot(`./__snapshots__/DangerCircleIcon.html`)
  })
