...
import { ChartDataIcon } from '../../components'
import { KUI_COLOR_TEXT_PRIMARY } from '@kong/design-tokens'

describe('ChartDataIcon', () => {
  it('matches snapshot', () => {
    const wrapper = mount(ChartDataIcon, {
      props: {
    ...
    expect(wrapper.html()).toMatchFileSnapshot(`./__snapshots__/ChartDataIcon.html`)
  })
