...
describe('AddCircleIcon', () => {
  it('matches snapshot', () => {
    ...
    expect(wrapper.html()).toMatchFileSnapshot(`./__snapshots__/AddCircleIcon.html`)
  })
