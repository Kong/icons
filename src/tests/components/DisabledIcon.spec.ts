...
import { DisabledIcon } from '../../components'
import { KUI_COLOR_TEXT_PRIMARY } from '@kong/design-tokens'

describe('DisabledIcon', () => {
  it('matches snapshot', () => {
    const wrapper = mount(DisabledIcon, {
      props: {
    ...
    expect(wrapper.html()).toMatchFileSnapshot(`./__snapshots__/DisabledIcon.html`)
  })
