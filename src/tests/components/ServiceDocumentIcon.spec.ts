...
import { ServiceDocumentIcon } from '../../components'
import { KUI_COLOR_TEXT_PRIMARY } from '@kong/design-tokens'

describe('ServiceDocumentIcon', () => {
  it('matches snapshot', () => {
    const wrapper = mount(ServiceDocumentIcon, {
      props: {
    ...
    expect(wrapper.html()).toMatchFileSnapshot(`./__snapshots__/ServiceDocumentIcon.html`)
  })
