...
Whether the SVG is meaningful to the page, or just complimentary. Utilized to expose or hide the SVG from screen readers and disable or enable pointer events.
